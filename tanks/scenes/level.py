...
from tanks.sprites import ConcreteWall, BrickWall, Bush, Water, Spike, Tank, Speedup, Shells, Rainbow, Ghost, shell_Speedup, Mirror, Shell, Coins, Coin
...
class Level(SceneBase):
    ...
    def __init__(self, filename: str, score: List[int] = None):
        ...
        #####################
        blocks = [BrickWall, Bush, ConcreteWall, Water, Spike, Speedup, Shells, Rainbow, Ghost, shell_Speedup, Mirror, Shell, Coin, Coins]
